...
func (r UserRepository) GetForToken(tokenScope string, tokenPlaintext string) (*User, error) {
...
func (r MockUserRepository) Insert(user *User) error {
	return nil
}
...
func (r MockUserRepository) GetForToken(tokenScope string, tokenPlaintext string) (*User, error) {
	return nil, nil
}
